...
def singleprecision(exponent,mantissa,sign_bit):
    ...
    bin_biased_exponent=("0"*zeroes_toadd)+str(int(float(bin_biased_exponent))) #adding zeroes to the exponent to make it 8-bit
...
def doubleprecision(exponent,mantissa,sign_bit):
    ...
    bin_biased_exponent=("0"*zeroes_toadd)+str(int(float(bin_biased_exponent))) #adding zeroes to the exponent to make it 11-bit
